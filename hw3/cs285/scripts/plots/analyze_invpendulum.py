...
def plot_eval_returns(data, output_dir):
    ...
    # Save figure
    filename = os.path.join(output_dir, "invPendulum_repara_eval_returns.png")
...
def plot_returns_comparison(data, output_dir):
    ...
    # Save figure
    filename = os.path.join(output_dir, "InvPendulum_repara_returns_comparison_eval.png")
    plt.savefig(filename, dpi=300, bbox_inches='tight')
    plt.close()
...
def main():
    ...
    logdir = './data/hw3_sac_sanity_invpendulum_reinforce_InvertedPendulum-v4_reinforce_s128_l3_alr0.0003_clr0.0003_b128_d0.99_t0.1_stu0.005_13-04-2025_14-16-39'
    logdir = './data/hw3_sac_sanity_invpendulum_reparametrize_InvertedPendulum-v4_reparametrize_s128_l3_alr0.0003_clr0.0003_b128_d0.99_t0.1_stu0.005_14-04-2025_07-57-32'
