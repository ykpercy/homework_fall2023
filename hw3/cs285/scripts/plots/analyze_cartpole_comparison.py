...
def plot_eval_return_comparison(data_dict, output_dir):
    ...
    # Save figure
    filename = os.path.join(output_dir, "eval_return_comparison.png")
...
def main():
    ...
    logdirs = [
        'data/hw3_dqn_dqn_CartPole-v1_s64_l2_d0.99_18-03-2025_09-21-02',
        'data/hw3_dqn_dqn_CartPole-v1_s64_l2_d0.99_19-03-2025_04-18-18'
    ]
    ...
    for logdir in logdirs:
        ...
        # print(f"Found {len(data)} metrics in {dataset_name}: {', '.join(data.keys())}")
    ...
    # Plot eval_return from both datasets
