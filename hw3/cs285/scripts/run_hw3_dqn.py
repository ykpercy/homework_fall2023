...
def run_training_loop(config: dict, logger: Logger, args: argparse.Namespace):
    ...
    for step in tqdm.trange(config["total_steps"], dynamic_ncols=True):
        ...
        if isinstance(replay_buffer, MemoryEfficientReplayBuffer):
            ...
            # ...
            # Handle the truncation case - if truncated, the episode is not truly done
            # for TD-learning purposes
            true_done = done and not truncated
        ...
        if done:
            ...
            # Add print statement for training return
            # print(f"Step {step}, Training Return: {info['episode']['r']:.2f}, Episode Length: {info['episode']['l']}")
